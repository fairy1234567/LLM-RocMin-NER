...
def get_roc_min(row):
    ...
    prediction_list=re.split(r'[，,\/n]',row["answer"][0])
...
def main():
    ...
    data_filename ="cate_confirm_gpt-3.5-turbo.json"  #"label_directly_together.json"  "label_with_knowledge_together.json"
