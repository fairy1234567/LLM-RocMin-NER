...
# Main function
def main():
    data_file = "../data/test.txt"  # "../data/test.txt"
    res_dir = "../recog_result_swap_labeling_symbols"  # "../recog_result"
    model = "gpt-4o-mini"  # "gpt-4o" "gpt-3.5-turbo" "claude-3-5-sonnet-20240620" "gpt-4o-2024-08-06"
