...
def process_matching(annotation, prediction, key):
    """
    Process the matching logic and return results including full matches, partial matches, misses,
    and results in the prediction that are not in the ground truth.
    """
    result_dict = {
        "full_matched": [],
        "matched": [],
