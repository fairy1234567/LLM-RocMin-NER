...
def get_roc_min(row):
    ...
    if entities_list:
        prediction=row["answer"][0]
        prediction_list=re.split(",|，|\/n",prediction)
    else:
        prediction_list=[]
...
def main():
    ...
    data_filename ="cate_confirm_claude-3.5-sonnet.json"  #"label_directly_together.json"  "label_with_knowledge_together.json"
